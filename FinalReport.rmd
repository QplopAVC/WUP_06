...
In the ggplot the the attitude of the white race is mostly in favor. The black attitudes are towards opposition. The blue bar is more than half of the white opposition. The other is about the same on average.
...
chisqtestGC(table2)
```
`The p value is 0.00000000000000022 which is very low. So I am going to ran a fisherXY test to check for more data.
...
```
In the fisherXY test all the p values were different and are all very low. The p value for white and black is 0.00000000000000022. The p value for white and other is 0.002607. The p value for back and other is 0.001564. 
